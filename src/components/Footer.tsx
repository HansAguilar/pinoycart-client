            ...
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    <a className="flex title-font font-medium items-center md:justify-start justify-center text-primary">
                        ...
                        <span className="ml-3 text-xl">PinoyCart</span>
                    </a>
                    <p className="mt-2 text-sm text-gray-500">PinoyCart is more than just a marketplace; it's a celebration of Filipino talent and a way to connect with your roots.</p>
                </div>
